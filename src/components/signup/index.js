...
import { Button, Label,  Col, Container, Form, Input, InputGroup, InputGroupAddon, InputGroupText, Row } from 'reactstrap';
              ...
              <Col md="9" lg="7" xl="6">
                <Card className="mx-4" style={{ marginTop: "50px" }}>
                  <CardBody className="p-4" > */}
                    ...
                    <Form onSubmit={this.props.onRegister} noValidate className="login_formSignin__27WMl">
